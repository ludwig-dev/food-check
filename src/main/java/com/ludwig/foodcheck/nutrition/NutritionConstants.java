...
public class NutritionConstants {
    public static final String SLV_BASE_URL = "https://dataportal.livsmedelsverket.se/livsmedel/api/v1/livsmedel/";

    public static final Map<String, Double> RDI = Map.ofEntries(
    ...
    public static final Set<String> RELEVANTA_NAMN = Set.of(
